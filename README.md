...
**Labs:**
- Lab 1: Edge Impulse Implementation of a Simple DNN for Classification
- Lab 2: TinyML Hardware and Sensor Setup
- Lab 3: Knowledge Distillation, Quantization and Pruning
- Lab 4: Visual Wake Words
- Lab 5: Keyword Spotting Using TinyML
- Lab 6: TinyML for Anomaly Detection
...
**Key concepts:** model quantization, knowledge distillation, pruning, TFLite deployment, on-device inference, sensor data processing